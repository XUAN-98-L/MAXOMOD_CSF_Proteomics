...
output_dir = "Brain/01_Pre_Processing"
...
#uniprot_to_genename = readRDS("Validation/01_Pre_Processing/uniprot_to_genename.rds")
...
output_dir = "Brain/02_Missing_Inspection"
if (!file.exists(output_dir)) {
  dir.create(output_dir, recursive = T)
}
...
output_dir = "Brain/001_Pre_Processing_als"
if (!file.exists(output_dir)) {
  dir.create(output_dir, recursive = T)
}
saveRDS(se_abu_data, file.path(output_dir, "se_abu_data.rds"))
...
output_dir = "Brain/02_Missing_Inspection_subclusters"
if (!file.exists(output_dir)) {
  dir.create(output_dir, recursive = T)
}
# the data is already normalize and imputed
