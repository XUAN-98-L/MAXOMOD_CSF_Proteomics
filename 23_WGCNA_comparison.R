...
option_list <- list(
  make_option(c("--input", "-i"),
              type = "character", default = "Validation/2_Missing_Inspection_als/norm_imp_MinProb.rds",
              help = "SummarizedExperiment object after normalize and imputation."
  ),make_option(c("--output", "-o"),
                type = "character", default = "23_WGCNA_comparison",
                ...
                type = "character", default = "Validation/5_Clustering_als/cluster_assignments_2.csv",
