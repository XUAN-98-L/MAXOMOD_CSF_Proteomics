#=========================Script Description=================================
# This script is used for pathway scatterplot between discovery and validation (ALS vs CTRL)
#===========================Loading Packages=============================
...
#============================================================================
Discovery = readRDS("Discovery/06_GSEA/GSEA_result.rds")
Discovery = Discovery$BP@result

Validation = readRDS("Validation/06_GSEA/GSEA_result.rds")
...
output_dir <- "14_Pathway_between_cohort_GSEA"
