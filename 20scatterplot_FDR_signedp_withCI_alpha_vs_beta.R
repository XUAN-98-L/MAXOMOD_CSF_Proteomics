...
# Rscript ~/Documents/Projects/MAXOMOD/Script/20scatterplot_FDR_signedp_withCI_alpha_vs_beta.R
#===========================Loading Packages=============================
...
option_list <- list(
  make_option(c("--input", "-i"),
              ...
              help = "8_Differential_expression_analysis_subclusters/res.rds"
                ...
                type = "character", default = "20_scatterplot_FDR_signedp_withCI_alpha_vs_beta",
