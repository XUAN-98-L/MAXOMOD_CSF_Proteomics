...
if (is.null(args$output_dir)) {
  output_dir <- paste0("42_AUC_comparision_noAge_", sd, "sd")
} else {
  output_dir <- args$output_dir
}
ML_results_10_input_folder = paste0(input_path, "/31_ML_multi_models_20250915_500_01_noAge_",sd,"sd")
...
ML_results_20_input_folder = paste0(input_path, "/31_ML_multi_models_20250915_500_02_noAge_",sd,"sd")
...
ML_results_30_input_folder = paste0(input_path, "/31_ML_multi_models_20250915_500_03_noAge_",sd,"sd")
...
ML_results_40_input_folder = paste0(input_path, "/31_ML_multi_models_20250915_500_04_noAge_",sd,"sd")
...
ML_results_50_input_folder = paste0(input_path, "/31_ML_multi_models_20250915_500_05_noAge_",sd,"sd")
...
ML_results_60_input_folder = paste0(input_path, "/31_ML_multi_models_20250915_500_06_noAge_",sd,"sd")
...
combined_plot <- plot_grid(
  auc_plot + theme(legend.position = "bottom"),  # 上图
  protein_barplot,                               # 下图
  ncol = 1, align = "v", axis = "lr"             # 垂直对齐，左右轴对齐
)
