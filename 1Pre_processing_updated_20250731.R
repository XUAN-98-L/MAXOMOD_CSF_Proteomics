...
# Rscript 1Pre_processing.R -e 1234 -t 0.5 >output.log
#===========================Loading Packages=============================
...
option_list <- list(
  make_option(c("--input", "-i"),
              ...
              type = "character", default = "1_pre_processing",
              ...
              type = "character", default = "/Users/xliu2942/Documents/Projects/MAXOMOD/data/database/HUMAN_9606_idmapping_selected.tab.gz",
