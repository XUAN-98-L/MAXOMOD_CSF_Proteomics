...
library(readxl)
#clinical_data_ALS <- read_excel('/Input/Updated_list_for_MAXOMOD_CSF_all_omics_and_clinic_2024.12.17 (clean version) - sent to Xuan.xlsx', sheet = 1)
#clinical_data_Control <- read_excel('/Input/Updated_list_for_MAXOMOD_CSF_all_omics_and_clinic_2024.12.17 (clean version) - sent to Xuan.xlsx', sheet = 2)
...
#library(openxlsx)
#clinical = read.xlsx('/Input/Updated list for MAXOMOD CSF_all omics and clinic_2023.11.29 (in use) - sent to clara.xlsx', sheet = 1)
