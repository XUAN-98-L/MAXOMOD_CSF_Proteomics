...
option_list <- list(
  make_option(c("--input", "-i"),
              type = "character", default = "26External_data/ALS_vs_ctrl/als_vs_ctrl.csv",
              help = "26External_data/ALS_vs_ctrl/als_vs_ctrl.csv"
  ),make_option(c("--output", "-o"),
                type = "character", default = "26_External_GSEA_allsamples",
