...
Discovery = readRDS("Discovery/19_GSEA_subclusters_k2/GSEA_result.rds")
Discovery = Discovery$BP@result

Validation = readRDS("Validation/19_GSEA_subclusters_k2/GSEA_result.rds")
...
output_dir <- "25Pathway_between_cohort_GSEA"
