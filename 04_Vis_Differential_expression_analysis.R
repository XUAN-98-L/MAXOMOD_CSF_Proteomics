...
option_list <- list(
  make_option(c("--input", "-i"),
              ...
              help = "03_Differential_expression_analysis/Differential_Expression_Results.rds"
                ...
                type = "character", default = "04_Vis_Differential_expression_analysis",
...
#===========================Save Plots======================================
ggarrange(plotlist = plots_FDR0.05, ncol = 2, nrow = 2)
ggsave(filename = file.path(output_dir, "FDR005.pdf"), width = 12, height = 10, units = "in")
