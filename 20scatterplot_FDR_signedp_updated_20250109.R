...
p = scatterplot_FDR_male_female(data, q = 0.95, main_title = "ALS vs Control(pvalue)",max.overlaps = Inf,lab_x = "signed -log10(pvalue) for Discovery",
