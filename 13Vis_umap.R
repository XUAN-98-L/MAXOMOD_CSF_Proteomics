...
#   Rscript ${root}13Vis_umap.R -e $i -d all -l TRUE
#Rscript ${root}13Vis_umap.R -e $i -d all -l FALSE
#Rscript ${root}13Vis_umap.R -e $i -d als -l TRUE -c 5_Clustering_als -i 2_Missing_Inspection_als
#Rscript ${root}13Vis_umap.R -e $i -d als -l FALSE -c 5_Clustering_als -i 2_Missing_Inspection_als
#Rscript ${root}13Vis_umap.R -e $i -d ctrl -l TRUE -c 5_Clustering_ctrl -i 2_Missing_Inspection_ctrl
#Rscript ${root}13Vis_umap.R -e $i -d ctrl -l FALSE -c 5_Clustering_ctrl -i 2_Missing_Inspection_ctrl
#===========================Loading Packages=============================
...
option_list <- list(
  make_option(c("--input", "-i"),
              ...
              help = "folder name which contains SummarizedExperiment object after normalize and imputation."
                ...
                type = "character", default = "13_Vis_umap",
