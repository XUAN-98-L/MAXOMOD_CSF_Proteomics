...
# Load data
protein_data <- readr::read_tsv("/Users/xliu2942/Documents/Projects/MAXOMOD/data/validataion/proteinGroups.txt")

library(openxlsx)
#demographic_data = read.xlsx('/Users/xliu2942/Documents/Projects/MAXOMOD/data/validataion/MAXOMOD validation cohort clinical data - Xuan_20241203.xlsx', sheet = 1)
demographic_data = read.xlsx('/Users/xliu2942/Documents/Projects/MAXOMOD/data/Final_metadata_20250528/1.MAXOMOD CSF validation cohort clinical data - 250414 Xuan (in use final).xlsx', sheet = 1)
...
clinical_data <- read.csv("/Users/xliu2942/Documents/Projects/MAXOMOD/data/validataion/SampleTracking.csv")
#demographic_data <- read_excel("/Users/xliu2942/Documents/Projects/MAXOMOD/data/validataion/validation cohort sex and age.xlsx")
