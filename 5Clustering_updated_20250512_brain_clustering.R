...
if(disease){
  ...
  clin_vars = c( "sex","age","onset") # "age", "sex", "Nfl",, "progression_rate", "onset" 
}else{
  #clin_vars = c( "sex", "Nfl",  "age") # "age", "sex", "Nfl",, "progression_rate", "onset" 
  clin_vars = c( "sex",  "age") # "age", "sex", "Nfl",, "progression_rate", "onset" 
}
...
colours = list(
  ...
  onset = c("spinal" = "#FDAE61", "bulbar" = "#FEE090", "ctrl" = "#B3B3B3", "Missing" = "#B3B3B3"),
  slow_vital_capacity = "#A6D854",
  disease_duration = "#8DA0CB",
  limb = c("upper" = "#6A5ACD", "lower" = "#FF7F50")
)
plots = list()
