...
option_list <- list(
  make_option(c("--input", "-i"),
              ...
              help = "SummarizedExperiment object after normalize and imputation."
                ...
                type = "character", default = "23_WGCNA",
...
#################WGCNA##################
#cleanDat_file = readRDS("/Users/xliu2942/Documents/Projects/MAXOMOD/Script/Discovery/2_Missing_Inspection_als/norm_imp_MinProb.rds")
#cluster_assignments_2_file = "/Users/xliu2942/Documents/Projects/MAXOMOD/Script/Discovery/5_Clustering_als/cluster_assignments_2.csv"
#output_dir = "/Users/xliu2942/Documents/Projects/MAXOMOD/Script/Discovery/23_WGCNA"
...
dev.off()
#genes = moduleLabels[moduleLabels$color == "turquoise",]$gene

#intersect between differentially expressed genes and module genes
#alpha_file = "/Users/xliu2942/Documents/Projects/MAXOMOD/Script/Discovery/9_Vis_Differential_expression_analysis_subclusters/all_important_protein_names_k2_alpha.csv"
#alpha = read.csv(alpha_file)

#go_enrich <- enrichGO(gene = intersect(genes,alpha$name),
#                      OrgDb = org.Hs.eg.db, 
#                      keyType = 'SYMBOL',
#                      ont = "BP",
#                      qvalueCutoff  = 0.05,
...
#enrich_result = mutate(go_enrich, logpadj = -log(p.adjust, base=10)) %>% filter(Count >= 3) 

#enrich_result %>% 
#  barplot(x="logpadj", showCategory=20)
